...
if __name__ == '__main__':
    c = AutoVC_mel_Convertor('/home/ubuntu/dataset/MIT/MIT_train_thresh', proportion=(0.0, 1.0))
    aus = c.convert_wav_to_autovc_input()
    print(len(aus))
    print(aus[0][0])
    print(aus[0][1][2])
    with open(os.path.join('/home/ubuntu/dataset/MIT/MIT_train_thresh', 'autovc_retrain_mel_au.pickle'), 'wb') as fp:
        pickle.dump(aus, fp)