...
class Av2Flau_Convertor():
    ...
    def convert(self, max_num_frames=2000, save_audio=False, show=False, register=False):
    ...
    def __preclean_video__(self, WriteFileName='_preclean.mp4', fps=25, sample_rate=16000):
        ...
        output_name = self.video_dir.replace(self.input_format, WriteFileName)
        # create preclean video
        # os.system(f'ffmpeg -hwaccel cuvid -c:v h264_cuvid -y -i {input_video_dir} -c:v h264_nvenc {output_name}')
    ...
    def __video_facial_landmark_detection__(self, video_dir=None, display=False, WriteFileName='_fl_detect.mp4',
                                            max_num_frames=2000, write=False):
        '''
