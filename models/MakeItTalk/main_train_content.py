...
parser.add_argument('--dump_dir', type=str, default='dump', help='')
...
try_mkdir(os.path.join(opt_parser.root_dir, 'nn_result'))
try_mkdir(os.path.join(opt_parser.root_dir, 'nn_result', opt_parser.name))
